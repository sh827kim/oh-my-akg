// plugins/utils.ts에서 이동. evidence, confidence 관련 공용 유틸리티
import { createHash } from 'node:crypto';
import path from 'node:path';
import type { EvidenceKind, EvidenceRecord, AstRelationType, ReviewLane } from './scanners/types';

export const CONFIDENCE_SCORE_VERSION = 'v1.0';
export const LOW_CONFIDENCE_THRESHOLD = 0.65;

// evidence 종류별 confidence 기여 가중치
